...
export function PasswordRequirementsPanel({
  ...
  const remainingCharacters = Math.max(
    0,
    PASSWORD_MIN_LENGTH - (password?.length ?? 0),
  );
        ...
        >
          <div className="text-sm text-slate-700">
            ...
            <p className="mt-1 text-sky-700">
              Tip: The strongest passwords are long phrases. We recommend using
              a memorable sentence or combining 3 to 4 unrelated words.
            </p>
          </div>

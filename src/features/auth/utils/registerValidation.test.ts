...
describe("validateRegisterForm", () => {
  ...
  describe("firstName", () => {
    it("requires firstName", () => {
      const { firstName } = validateRegisterForm(
  ...
  describe("lastName", () => {
    ...
    it("treats whitespace-only lastName as blank", () => {
      const { lastName } = validateRegisterForm(
  ...
  describe("email", () => {
    ...
    it("accepts a well-formed email", () => {
      const { email } = validateRegisterForm(
        validFields({ email: "user@university.ac.lk" }),
      );
  ...
  describe("password", () => {
    it("requires password", () => {
      const { password } = validateRegisterForm(
        validFields({ password: "", confirmPassword: "" }),
      );
...
describe("mapBackendFieldErrors", () => {
  ...
  it("prefers message over issue when both are present", () => {
    const error = apiError({
      details: [
        { field: "email", message: "From message.", issue: "From issue." },
      ],
    });

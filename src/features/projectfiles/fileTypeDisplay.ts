...
const FILE_TYPE_CONFIG: Record<string, FileTypeDisplay> = {
  pdf: {
    label: "PDF",
    toneClassName: "bg-rose-100 text-rose-700 border border-rose-200",
  },
  doc: {
    label: "DOC",
    toneClassName: "bg-blue-100 text-blue-700 border border-blue-200",
  },
  docx: {
    label: "DOCX",
    toneClassName: "bg-blue-100 text-blue-700 border border-blue-200",
  ...
  ppt: {
    label: "PPT",
    toneClassName: "bg-orange-100 text-orange-700 border border-orange-200",
  },
  pptx: {
    label: "PPTX",
    toneClassName: "bg-orange-100 text-orange-700 border border-orange-200",
  ...
  zip: {
    label: "ZIP",
    toneClassName: "bg-violet-100 text-violet-700 border border-violet-200",
  },
  txt: {
    label: "TXT",
  ...
  json: {
    label: "JSON",
    toneClassName: "bg-amber-100 text-amber-700 border border-amber-200",
  },
  png: {
    label: "PNG",
    toneClassName: "bg-cyan-100 text-cyan-700 border border-cyan-200",
  },
  jpg: {
    label: "JPG",
    toneClassName: "bg-cyan-100 text-cyan-700 border border-cyan-200",

...
describe('normalizeGitHubRepositoryUrl', () => {
  it('normalizes canonical URL', () => {
    expect(
      normalizeGitHubRepositoryUrl('https://github.com/Nimsara-Jayarathna/ResearchTrack-Frontend'),
  ...
  it('accepts host without scheme', () => {
    expect(
      normalizeGitHubRepositoryUrl('github.com/Nimsara-Jayarathna/ResearchTrack-Frontend'),
    ).toBe('https://github.com/Nimsara-Jayarathna/ResearchTrack-Frontend');
  });
  ...
  it('rejects invalid formats', () => {
    ...
    expect(
      normalizeGitHubRepositoryUrl('https://gitlab.com/Nimsara-Jayarathna/ResearchTrack-Frontend'),
    ).toBeNull();

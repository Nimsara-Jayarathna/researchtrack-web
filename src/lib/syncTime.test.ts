...
describe("formatLastSynced", () => {
  ...
  it("formats minutes, hours, and days relatively", () => {
    expect(formatLastSynced("2026-04-14T11:35:00Z", now).displayText).toBe(
      "25m ago",
    );
    expect(formatLastSynced("2026-04-14T09:00:00Z", now).displayText).toBe(
      "3h ago",
    );
    expect(formatLastSynced("2026-04-12T12:00:00Z", now).displayText).toBe(
      "2d ago",
    );
  });
